...
pub mod parsers {
    ...
    pub fn parse_common(i: &str) -> IResult<&str, (&str, &str)> {
        match tuple((parse_date, parse_mod))(i) {
    ...
    pub fn parse_p0f_uptime(i: &str) -> IResult<&str, P0f> {
        ...
        {
            Ok((_remain, (date, module, client, server, subject, uptime, raw_freq))) => Ok((
                "",
                P0f::Uptime {
    ...
    pub fn parse_p0f_mtu(i: &str) -> IResult<&str, P0f> {
        ...
        {
            Ok((_remain, (date, module, client, server, subject, link, raw_mtu))) => Ok((
                "",
                P0f::Mtu {
                    date: String::from(date),
                    module: String::from(module),
    ...
    pub fn parse_p0f_host_change(i: &str) -> IResult<&str, P0f> {
        ...
        {
            Ok((_remain, (date, module, client, server, subject, reason, raw_hits))) => Ok((
                "",
                P0f::HostChange {
                    date: String::from(date),
                    module: String::from(module),
